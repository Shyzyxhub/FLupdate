...
/**
 * Classe principale du plugin FarLandsAgain.
...
public class FarLandsAgain extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        // Catch worlds that are already loaded (reload or pre-existing)
    ...
    /**
     * Vérifie si le serveur est Paper.
     */
    ...
    public void onDisable() {
        // Restaure les générateurs originaux
    ...
    /**
     * Prépare le monde pour Far Lands si activé dans la config.
     */
